...
void load_meta_parameters(const std::string& filename) {
    ...
    while (std::getline(file, line)) {
        ...
        if (key == "max_iterations") {
            iss >> meta_parameters.max_iterations;
            ...
            if (type == "FirstImprovement") {
                meta_parameters.local_search_type = MetaParameters::LocalSearchType::FirstImprovement;
            } else if (type == "BestImprovement") {
                meta_parameters.local_search_type = MetaParameters::LocalSearchType::BestImprovement;
            }
    ...
    std::size_t p = Model::get_parameters().target_num_sites;
